        ...
        <motion.nav
            ...
            <div className='mx-auto flex h-12 max-w-7xl items-center justify-start px-3 sm:px-5'>
                <div onClick={() => navigate("/dashboard")}
                    ...
                    <span className='text-sm font-extrabold sm:text-base text-[#0A0A0A]'>CareerPilot AI</span>
...
function Scorer({ user, setUser }) {
    ...
    const uploadResume = async () => {
        ...
        try {
            ...
            console.log(error)
            alert(error?.response?.data?.message || error?.message || "Resume upload failed")
            setLoading(false)
        }
    }
    // scorer section
        ...
        <div className='min-h-screen bg-white text-[#0A0A0A]'>
            ...
            <section className='flex min-h-screen items-center justify-center px-3 pt-18 pb-6'>
              ...
              ${file
                        ...
                        <p className="text-[10px] text-white/35 mt-1">PDF, DOCX, PNG, JPG, WEBP · Max 20MB</p>
